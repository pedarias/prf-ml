...
def train_model():
    ...
    mlflow.set_experiment("Acidentes de Trânsito - SMOTE + Class Weights + RandomizedSearch")
    ...
    # Ajustar os espaços de hiperparâmetros
    ...
    for model_name, model in models.items():
        ...
        log_mlflow(
            ...
            best_model,
            preprocessor,
            run_name=f"{model_name} com SMOTE e Class Weights - Hyperparameter Tuning"
        )

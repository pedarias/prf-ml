...
def train_model():
    ...
    mlflow.set_experiment("Acidentes de Trânsito - TomekLinks + Class Weights")
    ...
    for model_name, model in models.items():
        ...
        log_mlflow(
            ...
            model,
            preprocessor,
            run_name=f"{model_name} com RandomUnderSampler e Class Weights"
        )
